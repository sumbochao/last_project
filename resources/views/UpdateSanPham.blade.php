...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <form action="{{route('processUpdateSanPham',['id'=>$sanPham->ma_san_pham])}}" class="form-horizontal"
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating is-empty has-error">
                                    ...
                                    <input type="number" name="soLuong" id="soLuong" class="form-control error"
                                           required="true" aria-required="true"
                                           aria-invalid="true" value="{{$sanPham->so_luong}}">
                                    <span class="material-input"></span>
                                </div>
                                <label class="col-sm-3 label-on-right">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="text" name="gia" id="gia" class="form-control error"
                                           required="true" aria-required="true"
                                           aria-invalid="true" value="{{$sanPham->gia}}">
                                    <span class="material-input"></span>
                                </div>
                                <label class="col-sm-3 label-on-right">
