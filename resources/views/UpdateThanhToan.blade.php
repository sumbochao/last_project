...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <form action="{{route('processUpdateThanhToan',['id'=>$thanhToan->ma_thanh_toan])}}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty has-error">
                                ...
                                <input type="text" name="phuongThucThanhToan" id="phuongThucThanhToan" class="form-control error"
                                       required="true" aria-required="true"
                                       aria-invalid="true" value="{{$thanhToan->phuong_thuc_thanh_toan}}">
