...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <form action="{{route('process_update_thanh_toan',['id'=>$thanh_toan->ma_thanh_toan])}}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty has-error">
                                ...
                                <input type="text" name="phuong_thuc_thanh_toan" id="phuong_thuc_thanh_toan" class="form-control error"
                                       required="true" aria-required="true"
                                       aria-invalid="true" value="{{$thanh_toan->phuong_thuc_thanh_toan}}">
                                <span class="material-input"></span>
                            </div>
                            <label class="col-sm-3 label-on-right">
                                <code><span id="phuong_thuc_thanh_toan_error"></span></code>
                            </label>
                        </div>
                    </div>
                </div>
                <button class="btn-success" onclick="return validateForm()">Sửa Phương Thức Thanh Toán</button>
                <a href="{{url()->previous()}}">
