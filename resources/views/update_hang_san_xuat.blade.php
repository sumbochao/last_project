...
@section('content')
    ...
    <form action="{{route('process_update_hang_san_xuat',['id'=>$hang_san_xuat->ma_hang_san_xuat])}}" class="form-horizontal" method="post">
        @csrf
                ...
                <div class="col-sm-10">
                    <div class="form-group label-floating is-empty has-error">
                        ...
                        <input type="text" name="ten_hang_san_xuat" id="ten_hang_san_xuat" class="form-control error"
                               ...
                               aria-invalid="true" value="{{$hang_san_xuat->ten_hang_san_xuat}}">
