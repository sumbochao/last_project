...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <form action="{{route('process_update_khach_hang',['id'=>$khach_hang->ma_khach_hang])}}" enctype="multipart/form-data"
                        ...
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty has-error">
                                ...
                                <input type="text" name="tai_khoan" id="tai_khoan" class="form-control error"
                                       ...
                                       aria-invalid="true" value="{{$khach_hang->tai_khoan}}">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty has-error">
                                ...
                                <input type="password" name="mat_khau" id="mat_khau" class="form-control error"
                                       required="true" aria-required="true"
                                       aria-invalid="true" value="{{$khach_hang->mat_khau}}">
                                <span class="material-input"></span>
                            </div>
                            <label class="col-sm-3 label-on-right">
                            ...
                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                ...
                                <div>
                                                    <span class="btn btn-rose btn-round btn-file">
                                                        ...
                                                        <input type="file" name="anh_khach_hang">
                                                    </span>
                ...
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty has-error">
                                <label class="control-label"></label>
                                <input type="text" name="ho_ten_khach_hang" id="ho_ten_khach_hang"
                                       class="form-control error" required="true" aria-required="true"
                                       aria-invalid="true" value="{{$khach_hang->ho_ten_khach_hang}}">
                                <span class="material-input"></span>
                            </div>
                            <label class="col-sm-3 label-on-right">
                                <code><span id="ho_ten_khach_hang_error"></span></code>
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty has-error">
                                ...
                                <input type="email" name="email" id="email" class="form-control error" required="true"
                                       aria-required="true"
                                       aria-invalid="true" value="{{$khach_hang->email}}">
                                <span class="material-input"></span>
                            </div>
                            <label class="col-sm-3 label-on-right">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty has-error">
                                ...
                                <input type="number" name="sdt" id="sdt" class="form-control error" required="true"
                                       aria-required="true"
                                       aria-invalid="true" value="{{$khach_hang->sdt}}">
                                <span class="material-input"></span>
                            </div>
                            <label class="col-sm-3 label-on-right">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group label-floating is-empty has-error">
                                ...
                                <input name="dia_chi" id="dia_chi" class="form-control error" required="true"
                                          aria-required="true"
                                          aria-invalid="true" value="{{$khach_hang->dia_chi}}">
                                <span class="material-input"></span>
                            </div>
                            <label class="col-sm-3 label-on-right">
